...
>>>>>>> 5e60f2534de5b3aebf2620834bd61e44a02503ed
---
...
GDP stands for Gross Domestic Product, and it is a key economic indicator used to measure the overall economic health and performance of a country or region @zotero-122. The variables relevant to us are;
...
result2 <- merged_data_temp |> 
  mutate(
    id_nuts2 = str_sub(geo, start = 1L, end = 2L)
  ) |> 
