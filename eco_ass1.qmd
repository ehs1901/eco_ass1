...
```{r}
#| echo: FALSE
# Få residualene fra den alternative modellen
...
```{r}
#| echo: FALSE
# Modell 1: Estimer effekten på NUTS-nivå med flere indekser
...
```{r}
#| echo: FALSE
# Modell 2: Estimer effekten på Year-nivå
...
```{r}
#| echo: FALSE
# Modell 3: Estimer effekten på NUTS2-nivå
...
# Anta at du har plm-modeller definert som plm1, plm2, plm3, plm4
# Erstatt disse med dine faktiske plm-modeller
