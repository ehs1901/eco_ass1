...
For Spain, a linear regression analysis was conducted to assess the relationship between the number of newly established companies (newfirms) and regional inequality (Gini coefficient) in 2010.
...
Similarly, for the Netherlands, a similar analysis was performed, and the results are consistent.
...
Finally, we want to include the variable KM from the highway data set to see if this can have an impact on regional inequalities in the three countries.
...
## References
>>>>>>> 4582ec2fc9d335c3c1e3f51d535db10ed71b33c0
