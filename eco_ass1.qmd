...
##### Results for EL in 2010: Intresting! plott dette også! 
...
1.  ES (Spain):
    ...
    -   R-squared (R\^2): 0.06275

    -   Adjusted R-squared: 0.007613
...
2.  PL (Poland):
    ...
    -   R-squared (R\^2): 0.03686

    -   Adjusted R-squared: -0.07015
...
4.  SI (Slovenia):
    ...
    -   R-squared (R\^2): 1 (Perfect fit, but with no degrees of freedom)
    ...
    -   R-squared (R\^2): 0.4704

    -   Adjusted R-squared: 0.4223
...
ggplot(subset_data, aes(x = gini_n2, y = GDP_per_capita)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y ~ x, color = "skyblue") +
